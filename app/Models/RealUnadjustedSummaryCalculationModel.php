...
class RealUnadjustedSummaryCalculationModel extends BaseResourceModel
{
    protected $table = "real_unadjusted_summary_calculations";
    protected $returnType = RealUnadjustedSummaryCalculation::class;
