...
return [
    ...
    'must_have_compound_data_key_if_document_value_matches' => 'Cannot check "{field}" due to developer error.',
    ...
    'has_valid_financial_entry_atom_group_values' => 'Financial entry values should be balanced or appropriate to the associated modifier action.',
